 ...
 */
final class Version20241202193919 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE forumsponsor (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, demande VARCHAR(255) NOT NULL, produit VARCHAR(255) NOT NULL, monatant INT NOT NULL, numtel INT NOT NULL, nom_etab VARCHAR(30) NOT NULL, domaine ENUM(\'IT\', \'Marketing\', \'Consulting\', \'Finance\',\'Chimie\',\'Civil\',\'Autres\'), autre_domaine VARCHAR(255) DEFAULT NULL, tetab ENUM(\'entreprise\', \'startup\', \'organisme\', \'institution_financière\'), description VARCHAR(255) NOT NULL, etat VARCHAR(30) NOT NULL, INDEX IDX_60101D86A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
